...
void BSP_LED_BlinkStandard_3(uint8_t bsp_ledx , BSP_LED_FuncBlink_e funcblink)
{
	...
	{
		case Blink_HighSpeed : BSP_Led_Blink(bsp_ledx , 3 , 30 ,100) ; break;
		case Blink_MidSpeed: BSP_Led_Blink(bsp_ledx , 2 , 30 ,500) ;break;
		case Blink_LowSpeed: BSP_Led_Blink(bsp_ledx , 3 , 50 ,1000) ;break;
		default:break;
	}
}
