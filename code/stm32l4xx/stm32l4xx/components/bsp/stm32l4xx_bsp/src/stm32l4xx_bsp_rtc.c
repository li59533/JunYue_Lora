...
/**
 * @defgroup      stm32l4xx_bsp_rtc_IO_Defines 
 * @brief         
 * @{  
 */
...
/**
 * @defgroup      stm32l4xx_bsp_rtc_Macros_Defines 
 * @brief         
 * @{  
 */
...
/**
 * @defgroup      stm32l4xx_bsp_rtc_Constants_Defines 
 * @brief         
 * @{  
 */
...
/**
 * @defgroup      stm32l4xx_bsp_rtc_Private_Types
 * @brief         
 * @{  
 */
...
/**
 * @defgroup      stm32l4xx_bsp_rtc_Private_Variables 
 * @brief         
 * @{  
 */
...
/**
 * @defgroup      stm32l4xx_bsp_rtc_Public_Variables 
 * @brief         
 * @{  
 */
...
/**
 * @defgroup      stm32l4xx_bsp_rtc_Private_FunctionPrototypes 
 * @brief         
 * @{  
 */
...
/**
 * @defgroup      stm32l4xx_bsp_rtc_Functions 
 * @brief         
 * @{  
 */
void BSP_RTC_Init(void)
{
	...
	{ 		
		...
		BSP_RTC_WriteClock(2019, 7, 19, 0, 2, 0);	/* 设置初始时间 */
...
uint8_t BSP_RTC_WriteClock(uint16_t _year, uint8_t _mon, uint8_t _day, uint8_t _hour, uint8_t _min, uint8_t _sec)
{
	...
	date.Month = _mon ; 
	date.Date = _day ;
	date.WeekDay = BSP_RTC_CalcWeek(_year, _mon, _day) ;	/* 周5=5， 周日=7 */
...
void RTC_ReadClock(void)
{
	...
	g_tRTC.Week = BSP_RTC_CalcWeek(g_tRTC.Year, g_tRTC.Mon, g_tRTC.Day);	/* 计算星期 */
}   
